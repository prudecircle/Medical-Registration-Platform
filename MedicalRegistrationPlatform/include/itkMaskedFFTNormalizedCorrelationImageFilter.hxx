...
::GenerateData()
{
  ...
  using PostProcessType = itk::TernaryFunctorImageFilter< RealImageType,RealImageType,RealImageType,RealImageType,Functor::PostProcessCorrelation<RealPixelType> >;
