...
public:
  ...
  void FillOffsets(Offset<ImageDimension>* const offsets) const ITK_NOEXCEPT
  {
...
private:
  ...
  constexpr std::size_t CalculateNumberOfOffsets(const unsigned dimension) const ITK_NOEXCEPT
  {
